...
def get_sensor_data_and_history(sensor_index, average_minutes, start_date, end_date, folder_name, fields, fields_to_extend):
    ...
    # Loop through date range in three-day intervals
    ...
    while current_start_date < end_date:
        ...
        data_total.extend(sensor_history['data'])
...
if __name__ == "__main__":
    ...
    average_minutes = config.get("average_minutes", 10)
